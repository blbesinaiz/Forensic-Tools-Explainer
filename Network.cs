...
Persist Security Info=False;";
        ...
        private void Network_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                string query = "select * from NetworkForensics";
        ...
        private void combo_Tools_SelectedIndexChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                OleDbCommand command = new OleDbCommand();
                command.Connection = connection;
                string query = "select * from NetworkForensics where Tool= '" + combo_Tools.Text + "'";
                command.CommandText = query;
    ...
    private void but_menu_Click(object sender, EventArgs e)
        {
            this.Hide();                //Hides Network Form from screen
